...
testAsync("combineLatest2", (done) => {

	let (src1, src2, _, _, _, _) = createSources()

	S.combineLatest2(src1, src2)
	-> S.log
	-> S.collect(res => {
		switch res {
			| Ok(_) => {
...
testAsync("combineLatest3", (done) => {

	let (src1, src2, src3, _, _, _) = createSources()

	S.combineLatest3(src1, src2, src3)
	-> S.log
	-> S.collect(res => {
		switch res {
			| Ok(_) => {
...
testAsync("combineLatest4", (done) => {

	let (src1, src2, src3, src4, _, _) = createSources()

	S.combineLatest4(src1, src2, src3, src4)
	-> S.log
	-> S.collect(res => {
		switch res {
			| Ok(_) => {
...
testAsync("combineLatest5", (done) => {

	let (src1, src2, src3, src4, src5, _) = createSources()

	S.combineLatest5(src1, src2, src3, src4, src5)
	-> S.log
	-> S.collect(res => {
		switch res {
			| Ok(_) => {
...
testAsync("combineLatest6", (done) => {

	let (src1, src2, src3, src4, src5, src6) = createSources()

	S.combineLatest6(src1, src2, src3, src4, src5, src6)
	-> S.log
	-> S.collect(res => {
		switch res {
			| Ok(_) => {
